package projects.tc2r.masterdetailflow31;
...
import projects.tc2r.masterdetailflow31.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ...
            ((WebView) rootView.findViewById(R.id.detail_area)).setWebChromeClient(new WebChromeClient());
